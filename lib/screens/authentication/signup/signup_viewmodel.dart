// lib/screens/authentication/signup/signup_viewmodel.dart
...
class SignupViewModel extends BaseViewModel {
  ...
  bool _validateFullName() {
    if (fullNameController.text.trim().isEmpty) {
      fullNameError = "name_required".tr();
      return false;
    }
    fullNameError = null;
    return true;
  ...
  bool validateAll() {
    bool valid = _validateFullName() & _validatePhone() & _validateEmail();
    notifyListeners();
    return valid;
  }
  ...
  Future<void> signUp(BuildContext context) async {
    ...
    try {
      ...
      if (result['success'] == 1) {
        ...
        await StorageHelper.write('otp', result['data'][0]['otp'].toString());
      ...
      if (context.mounted) {
        SnackbarHelper.showError(context, 'Signup failed');
      }
    }
  }
